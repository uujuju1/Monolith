...
public class ModularPlanetGenerator extends PlanetGenerator {
	...
	public float tnoise(float x, float y, double octaves, double persistence, double scale) {return noise(x, y, octaves, persistence, scale);}
	...
	public class Biome {
		...
		*/
		...
		public @Nullable Block getBlock(Vec3 pos) {
			...
			float noise = Mathf.map(noise(pos), minValue, maxValue, 0, 1);
